...
const DetailPenawaran = ({ isOpen, onClose, detailData }) => {
  ...
  const calculateTotals = () => {
    ...
    console.log('[Admin Detail] Grand Total - Disc/Lain2 calculation:');
    ...
    console.log('[Admin Detail] Profit dari HJT calculation:');
    ...
    console.log('[Admin Detail] Margin dari HJT calculation:');
