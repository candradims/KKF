        ...
        <div style={{ padding: '20px' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {[
                { label: 'Tanggal', placeholder: '23/07/2025', type: 'date' },
                { label: 'Pelanggan', placeholder: 'Nama Pelanggan' },
                { label: 'Pekerjaan', placeholder: 'Pekerjaan' },
                { label: 'Nomor Kontrak / BAKBB', placeholder: 'Nomor kontrak' },
                { label: 'Kontrak Tahun ke-', placeholder: 'Kontrak tahun ke berapa' },
                { label: 'Referensi HJT', placeholder: 'HJT' },
                { label: 'Discount', placeholder: 'Discount' },
                { label: 'Durasi Kontrak (n thn)', placeholder: 'Durasi kontrak (n thn)' },
                { label: 'Target IRR', placeholder: 'Target IRR' },
                { label: 'Disc thdp Backbone', placeholder: '0,00%' },
                { label: 'Disc thdp Port (max 60%)', placeholder: '0,00%' }
              ].map((field, index) => (
