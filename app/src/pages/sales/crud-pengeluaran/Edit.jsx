                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: '500',
                      color: 'white',
                      backgroundColor: (isSaving || !hasDataChanged()) ? '#ccc' : '#00BCD4',
                      border: 'none',
                      borderRadius: '4px',
                    ...
                    onMouseOver={(e) => {
                      if (!isSaving && hasDataChanged()) e.target.style.backgroundColor = '#0097A7';
                    }}
                    onMouseOut={(e) => {
                      if (!isSaving && hasDataChanged()) e.target.style.backgroundColor = '#00BCD4';
                    }}
                  >
